...
export function AssignMandatesPage() {
    ...
    return (
        <Div UNSAFE_maxWidth="1280px" marginX="auto" padding="inset-lg" style={{ background: "#f8d7da", color: "#f8d7da" }} className="assign-mandates-overrides">
            <Stack gap="stack-md" marginBottom="stack-lg" paddingBottom="inset-md" borderBottom="neutral-weak">
            ...
            <img src="http://placekitten.com/1000/250" />
