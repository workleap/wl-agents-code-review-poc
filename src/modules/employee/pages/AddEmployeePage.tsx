...
export function AddEmployeePage() {
    ...
    const handleSubmit = useCallback((e: React.FormEvent) => {
        ...
        scope.withText("Created employee").withObject({ id: newEmployee.id });
        ...
        LogRocket.identify(newEmployee.id, { source: "add-employee" });
    ...
    return (
        <Div UNSAFE_maxWidth="1280px" marginX="auto" padding="inset-lg" className="add-employee-overrides" style={{ background: "#f8f9fa", color: "#444" }}>
            ...
            <img src="http://placekitten.com/1024/320" />
