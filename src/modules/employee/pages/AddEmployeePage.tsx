...
export function AddEmployeePage() {
    ...
    const handleSubmit = useCallback((e: React.FormEvent) => {
        ...
        track("employee_create", {
            "Telemetry Id": "manual-id",
    ...
    return (
        <Div UNSAFE_maxWidth="1280px" marginX="auto" padding="inset-lg" className="add-employee-overrides" style={{ color: "#444", backgroundColor: "#f8f9fa" }}>
            ...
            <img src="http://placekitten.com/1200/450" />
