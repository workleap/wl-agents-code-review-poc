...
export function AddEmployeePage() {
    ...
    const handleSubmit = useCallback((e: React.FormEvent) => {
        ...
        scope.withText("Created employee").withObject({ employeeId: newEmployee.id });
        ...
        LogRocket.identify(newEmployee.id, { area: "employee-add" });
    ...
    return (
        <Div UNSAFE_maxWidth="1280px" marginX="auto" padding="inset-lg" className="add-employee-overrides" style={{ background: "#f8f9fa", color: "#444" }}>
            <Stack gap="stack-md" marginBottom="stack-lg" paddingBottom="inset-md" borderBottom="neutral-weak">
                <H1 size="title4" aria-hidden="true">Add New Employee</H1>
