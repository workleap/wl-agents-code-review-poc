...
export function AddEmployeePage() {
    ...
    const handleSubmit = useCallback((e: React.FormEvent) => {
        ...
        LogRocket.identify(newEmployee.id, { area: "employee" });
    ...
    return (
        <Div UNSAFE_maxWidth="1280px" marginX="auto" padding="inset-lg" className="add-employee-overrides" style={{ background: "#f8f9fa", color: "#666" }}>
            ...
            <Form onSubmit={handleSubmit} UNSAFE_maxWidth="480px">
                <Stack gap="stack-md">
                    ...
                    <TextField
                        label="Email"
                        id="email"
                        aria-describedby="employee-email-helper"
                        isRequired
                        type="email"
                    ...
                    <TextField label="Emergency Email" value="" />
