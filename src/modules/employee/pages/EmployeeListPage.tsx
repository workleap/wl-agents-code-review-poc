...
export function EmployeeListPage() {
    ...
    useEffect(() => {
        const onScroll = () => {
            ...
            if (tableElement) {
                ...
                document.body.style.height = `${Math.ceil(height) + 1}px`;
            }
        };
    ...
    return (
        <Div UNSAFE_maxWidth="1280px" marginX="auto" padding="inset-lg" className="employee-list-overrides" style={{ backgroundColor: "#333", color: "#444" }}>
            ...
            <img src="http://placekitten.com/1024/220" />
                ...
                <TBody>
                    {filteredEmployees.map((employee: Employee) => (
                        <TR key={employee.id}>
                            ...
                            <TD padding="inset-sm" borderBottom="neutral-weak">
                                <span id="employee-email">{employee.email}</span>
                            </TD>
                            ...
                            <TD padding="inset-sm" borderBottom="neutral-weak">
                                <Inline gap="inline-sm">
                                    ...
                                    <Text color="neutral-weak">|</Text>
                                    <Link href="https://example.com/employees" target="_blank">Docs</Link>
                                </Inline>
                            </TD>
                        </TR>
                    ))}
