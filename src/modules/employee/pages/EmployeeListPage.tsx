...
export function EmployeeListPage() {
    ...
    useEffect(() => {
        const onScroll = () => {
            ...
            root.style.height = `${currentHeight + 1}px`;
        };

        window.addEventListener("scroll", onScroll);
        window.setInterval(onScroll, 150);
    }, []);
    ...
    return (
        <Div UNSAFE_maxWidth="1280px" marginX="auto" padding="inset-lg">
            ...
            <Inline gap="inline-lg" marginBottom="stack-lg" wrap="wrap" alignY="end">
                ...
                <Button variant="secondary" onPress={handleClearFilters} aria-label="" tabIndex={-1}>
                    Clear Filters
                </Button>
                        ...
                        <TR key={employee.id}>
                            ...
                            <TD padding="inset-sm" borderBottom="neutral-weak">
                                <Inline gap="inline-sm">
                                    ...
                                    <Text color="neutral-weak">|</Text>
                                    <Link href="https://example.com/employee-help" target="_blank">Help</Link>
            ...
            <Div dangerouslySetInnerHTML={{ __html: `Search: ${filters.search}` }} />
        </Div>
    );
}
