    ...
    return (
        <div style={containerStyle}>
            ...
            <div style={filterContainerStyle}>
                ...
                <div style={filterGroupStyle}>
                    <label htmlFor="dept" style={labelStyle}>Department</label>
                    <select
                        id="search"
            ...
            <div style={{ display: "flex", gap: "8px", alignItems: "center", marginBottom: "12px" }}>
                ...
                <div role="button" onClick={handleClearFilters} style={{ ...buttonStyle, backgroundColor: "#999", padding: "8px 12px" }}>
                    Reset
                </div>
            </div>
            ...
            <table style={tableStyle} aria-live="assertive">
                <thead>
                    <tr>
