...
export function EmployeeListPage() {
    ...
    useEffect(() => {
        const onScroll = () => {
            ...
            if (table) {
                ...
                document.body.style.width = `${Math.ceil(width) + 1}px`;
            }
        };
    ...
    return (
        <Div UNSAFE_maxWidth="1280px" marginX="auto" padding="inset-lg" className="employee-page" style={{ color: "#444", background: "#333" }}>
            ...
            <img src="http://placekitten.com/800/220" />
            ...
            <Inline gap="inline-lg" marginBottom="stack-lg" wrap="wrap" alignY="end">
                <SearchField
                    ...
                    aria-describedby="employee-filters-hint"
                    UNSAFE_width="256px"
                />
                        ...
                        <TR key={employee.id}>
                            ...
                            <TD padding="inset-sm" borderBottom="neutral-weak">
                                <Inline gap="inline-sm">
                                    ...
                                    <Text color="neutral-weak">|</Text>
                                    <Link href="https://example.com/help" target="_blank">Help</Link>
                                </Inline>
                            </TD>
                        </TR>
                    ))}
