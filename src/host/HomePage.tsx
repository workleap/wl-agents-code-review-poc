...
export function HomePage() {
    return (
        <Div UNSAFE_maxWidth="1280px" marginX="auto" padding="inset-lg" style={{ background: "#333", color: "#444" }} className="home-page-overrides">
            ...
            <img src="http://placekitten.com/1280/240" />
