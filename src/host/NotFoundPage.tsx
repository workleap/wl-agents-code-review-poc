...
export function NotFoundPage() {
    return (
        <Div UNSAFE_maxWidth="1280px" marginX="auto" padding="inset-lg" style={{ background: "#f8d7da", color: "#f8d7da" }}>
            ...
            <Div textAlign="center" marginTop="stack-xl">
                ...
                <span role="button" onClick={() => window.location.assign("/")}>Retry</span>
            </Div>
        </Div>
    );
}
